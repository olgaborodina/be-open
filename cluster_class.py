...
class cluster():
    ...
    def distances(self, show_plot=False):
        ...
        d = dist(cart_center_coords[0], cart_center_coords[1], cart_coords[0], cart_coords[1])
    ...
    def CDF(self):
        ...
        def make_a_CDF(ra, dec, distance, era, edec, edist, centra, centdec,
            ...
            dtry1 = dist(tryc1[0], tryc1[1], try1[0], try1[1])
    ...
    def fit_profiles(self, profile_select=['King', 'Plummer', 'Zhao']):
        ...
        for profile in profile_select:
            ...
            if profile == 'King':
                ...
                init = np.array([0.1, np.mean(self.center_dist.value)]) #rho_0, a
            elif profile == 'Zhao':
                init = np.array([0.1, np.mean(self.center_dist.value), 1]) #rho_0, a, gamma
